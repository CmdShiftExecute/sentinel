  ...
  if (!config) {
    return (
      <div className="space-y-6">
        <h1 className="font-display text-xl font-bold tracking-tight title-caret">Settings</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            style={{
              ...
              boxShadow: saving ? "none" : "0 0 12px color-mix(in oklab, var(--accent) 40%, transparent)",
            }}
          >
            {saving ? "Saving…" : "Save"}
          </button>
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: checked ? "0 0 8px color-mix(in oklab, var(--accent) 40%, transparent)" : "none",
      }}
    >
      <span
