  ...
  return (
    <>
      {Array.from({ length: 5 }).map((_, i) => (
        <div
          key={i}
          className="card-static px-4 py-3 flex gap-3 animate-pulse"
          style={{
...
export default function ActivityPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="font-display text-xl font-bold tracking-tight title-caret">
        Server Logs
      </h1>
        ...
        {isLoading ? (
          ...
          events.map((event, i) => {
            ...
            return (
              <div
                key={event.id}
                className="card-static px-4 py-3 flex gap-3 transition-all hover:shadow-md"
                style={{
