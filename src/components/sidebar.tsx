...
const NAV_ITEMS = [
  ...
  { href: "/browser-agent", label: "Browser Agent", icon: IconBrowser },
    ...
    <>
      ...
      <aside
        ...
        style={{
          ...
          borderRight: "1px solid color-mix(in oklab, var(--accent) 10%, transparent)",
              ...
              return (
                <li key={href} className="relative">
                  ...
                  <Link
                    href={href}
                    className={clsx(
                      "nav-link flex items-center gap-3 px-3 py-2 rounded text-[13px] font-medium transition-all duration-150",
                      active
                        ? "bg-accent-surface text-accent"
                        : "text-txt-secondary hover:text-txt-primary hover:bg-surface-hover"
                    )}
                    style={active ? { boxShadow: "inset 0 0 12px color-mix(in oklab, var(--accent) 8%, transparent)" } : undefined}
                  >
      ...
      <nav
        ...
        style={{
          ...
          backdropFilter: "blur(16px) saturate(1.4)",
          WebkitBackdropFilter: "blur(16px) saturate(1.4)",
          borderTop: "1px solid color-mix(in oklab, var(--accent) 10%, transparent)",
...
function IconBrowser({ size, active }: { size: number; active: boolean }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" stroke="currentColor"
      strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: active ? 1 : 0.6 }}>
      ...
      <polyline points="5.5,10 7.5,8 5.5,8" />
      <line x1="7.5" y1="8" x2="7.5" y2="10.5" />
    </svg>
  );
}
